...
\tableofcontents
\newpage
\section{src/DialecticalInterpreter.jsx}
...
\end{minted}
\newpage
\section{src/main.jsx}
\begin{minted}[breaklines, linenos, fontsize=\small, frame=single]{javascript}
import React from 'react';
import ReactDOM from 'react-dom/client';
import DialecticalInterpreter from './DialecticalInterpreter';

ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    <DialecticalInterpreter />
  </React.StrictMode>
);
