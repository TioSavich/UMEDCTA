...
\node[pnode] (S) at (0,8.0) {P\textsubscript{S}\\\textsubscript{Sliding}};
\node[pnode] (SC) at (4,6.5) {P\textsubscript{SC}\\\textsubscript{Subtraction COBO Missing Addend}};
\node[pnode] (SCCBBBAO) at (8,5.0) {P\textsubscript{SCCBBBAO}\\\textsubscript{Subtraction CBBO Counting Back by Bases and Ones}};
\node[pnode] (SD) at (12,3.5) {P\textsubscript{SD}\\\textsubscript{Subtraction Decomposition Borrowing}};
