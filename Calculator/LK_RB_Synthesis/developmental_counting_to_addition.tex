...
\node[pnode] (RAA) at (8,5.0) {P\textsubscript{RAA}\\\textsubscript{Rounding and Adjusting Addition}};
\node[pnode] (C) at (12,3.5) {P\textsubscript{C}\\\textsubscript{Chunking Addition}};
