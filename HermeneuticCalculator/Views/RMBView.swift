...
struct RMBView: View {
    @State private var addend1String = "8"
    @State private var addend2String = "5"
    ...
    private func calculate() {
        ...
        var automaton = RMBAutomaton(a: a, b: b)
        automaton.run()
...
struct RMBView_Previews: PreviewProvider {
